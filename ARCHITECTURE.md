...
- [`test/terminal-renderer.test.ts`](./test/terminal-renderer.test.ts) verifies that an interactive task and its answer, actions, and outcome share one terminal-local conversation-turn number;
